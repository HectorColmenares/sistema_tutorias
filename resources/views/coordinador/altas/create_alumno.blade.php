...
@section('content')
    <div style="width:100%; max-width: 900px;">
        <div class="welcome">
            ...
            <form method="POST" action="{{ route('coordinador.altas.alumno.store') }}" class="user-info"
                ...
                <p style="margin-top:14px;"><strong>Datos de alumno</strong></p>
                <p><strong>No. Control:</strong> <input name="numero_control" value="{{ old('numero_control') }}" required
                        style="flex:1;padding:8px;border-radius:8px;border:1px solid #ddd;"></p>
                <p><strong>Carrera:</strong> <input name="carrera" value="{{ old('carrera') }}" required
                        style="flex:1;padding:8px;border-radius:8px;border:1px solid #ddd;"></p>
                <p><strong>Grupo:</strong> <input name="grupo" value="{{ old('grupo') }}"
                        style="flex:1;padding:8px;border-radius:8px;border:1px solid #ddd;"></p>
                ...
                <div style="display:flex; gap:12px; margin-top:14px; justify-content:center;">
                    <button type="submit"
                        style="background:#1B396A;color:#fff;padding:10px 14px;border-radius:10px;border:none;font-weight:800;cursor:pointer;">
                        Guardar
                    </button>
